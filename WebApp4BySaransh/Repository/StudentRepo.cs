...
namespace WebApp4BySaransh.Repository
{
    public class StudentRepo
    {
        public void AddRecord(Student stu)
        {
            string conStr = @"Server= SARANSHPAVILION; database= SaranshNCCPractical; integrated security=SSPI;TrustServerCertificate=True";
